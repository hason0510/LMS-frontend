    ...
    <div className="!min-h-screen !bg-slate-50 dark:!bg-slate-950">
      ...
      <main className="!mx-auto !w-full !max-w-[1280px] !px-4 !pb-12 !pt-16 sm:!px-6 lg:!px-8">
        ...
        <header className="!mb-7 !flex !flex-col !gap-3 sm:!flex-row sm:!items-end sm:!justify-between">
          ...
          <span className="!shrink-0 !rounded-full !border !border-slate-200 !bg-white !px-4 !py-2 !text-sm !font-semibold !text-slate-600 dark:!border-slate-800 dark:!bg-slate-900 dark:!text-slate-200">
